...
import { isIdealistaTarget, scrapeIdealistaProperty } from "./idealista.js";
import { normalizeText, parseAreaM2, parseSpanishMoney } from "./parse.js";
...
export async function scrapePropertyPage(baseUrl: string, ref: string): Promise<PropertyRow | null> {
  if (isIdealistaTarget(baseUrl)) {
    return scrapeIdealistaProperty(ref);
  }
